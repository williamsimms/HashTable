...
TEST_CASE("List inserts Node at head element of list.", "[Insert Head]") {
  ...
  REQUIRE(list.Head()->data == 114);
  REQUIRE(list.Head()->previous == nullptr);
  REQUIRE(list.Head()->next->data == 12);

  list.PushFront(32);

  REQUIRE(list.Size() == 3);

  REQUIRE(list.Head()->data == 32);
  REQUIRE(list.Head()->previous == nullptr);
  REQUIRE(list.Head()->next->data == 114);
}
...
TEST_CASE("List inserts Node at tail element of list.", "[Insert Last]") {
  ...
  REQUIRE(list.Tail()->data == 114);
  REQUIRE(list.Tail()->previous->data == 12);
  REQUIRE(list.Tail()->next == nullptr);
  ...
  REQUIRE(list.Tail()->data == 32);
  REQUIRE(list.Tail()->previous->data == 114);
  REQUIRE(list.Tail()->next == nullptr);
}
...
TEST_CASE("Appends Many Nodes to the Start Of The List",
  ...
  list.InsertManyAtStart({1, 5, 6, 2});

  REQUIRE(list.Size() == 4);

  REQUIRE(list.At(0)->data == 2);
  REQUIRE(list.At(1)->data == 6);
  REQUIRE(list.At(2)->data == 5);
  REQUIRE(list.At(3)->data == 1);

  list.InsertManyAtStart({4, 2, 5, 7});

  REQUIRE(list.Size() == 8);

  REQUIRE(list.At(0)->data == 7);
  REQUIRE(list.At(1)->data == 5);
  REQUIRE(list.At(2)->data == 2);
  REQUIRE(list.At(3)->data == 4);
  REQUIRE(list.At(4)->data == 2);
  REQUIRE(list.At(5)->data == 6);
  REQUIRE(list.At(6)->data == 5);
  REQUIRE(list.At(7)->data == 1);
}
...
TEST_CASE("Appends Many Nodes to the End Of The List", "[Insert Many At End]") {
  ...
  REQUIRE(list.At(0)->data == 1);
  REQUIRE(list.At(1)->data == 5);
  REQUIRE(list.At(2)->data == 6);
  REQUIRE(list.At(3)->data == 2);
  ...
  REQUIRE(list.At(2)->data == 6);
  REQUIRE(list.At(3)->data == 2);
  REQUIRE(list.At(4)->data == 4);
  REQUIRE(list.At(5)->data == 2);
  REQUIRE(list.At(6)->data == 5);
  REQUIRE(list.At(7)->data == 7);
}
...
TEST_CASE("Returns the node at the given Index", "[Get At]") {
  SECTION("Returns the node at the given index.") {
    ...
    REQUIRE(list.At(0)->data == 2);
    REQUIRE(list.At(1)->data == 8);
    REQUIRE(list.At(2)->data == 4);
    REQUIRE(list.At(3)->data == 1);
  }
...
TEST_CASE("Removes the node at the specified Index.", "[Remove At]") {
  ...
  SECTION("Remove At deletes the node at the specified index.") {
    ...
    REQUIRE(list.At(1)->data == 2);

    list.PopAt(1);

    REQUIRE(list.At(1)->data == 3);
  }
...
TEST_CASE("Inserts a New Node at the Specified Index.", "[Insert At]") {
  ...
  SECTION(
      "Inserts a new node with data at the 0 index when the list has "
      "elements.") {
    LinkedList<int, int> list;
    ...
    REQUIRE(list.At(0)->data == 5);
    REQUIRE(list.At(1)->data == 7);
    REQUIRE(list.At(2)->data == 4);
    REQUIRE(list.At(3)->data == 2);
  }
  ...
  SECTION("Inserts a new node at the middle index of the list.") {
    ...
    REQUIRE(list.At(0)->data == 2);
    REQUIRE(list.At(1)->data == 7);
    REQUIRE(list.At(2)->data == 9);
    REQUIRE(list.At(3)->data == 3);
    REQUIRE(list.At(4)->data == 4);
  }

  SECTION("Inserts a new node with data at the last index.") {
    LinkedList<int, int> list;
    ...
    REQUIRE(list.At(0)->data == 2);
    REQUIRE(list.At(1)->data == 7);
    REQUIRE(list.At(2)->data == 3);
  }

  SECTION(
      "Inserts a new node at index 0 with data when the index less than "
      "zero.") {
    LinkedList<int, int> list;
    ...
    REQUIRE(list.At(0)->data == 5);
    REQUIRE(list.At(1)->data == 2);
    REQUIRE(list.At(2)->data == 7);
  }

  SECTION(
      "Inserts a new node at last index with data when the index is greater "
      "than N-1") {
    LinkedList<int, int> list;
...
TEST_CASE("Updates the specified index with the provided data.",
          "[Update Index]") {
  ...
  SECTION("Returns true and updates the index with the supplied data.") {
    LinkedList<int, int> list;
    ...
    REQUIRE(list.At(0)->data == 22);
    REQUIRE(list.At(1)->data == 5);
    REQUIRE(list.At(2)->data == 8);
    REQUIRE(list.At(3)->data == 19);
  }
}
...
TEST_CASE("Updates the first element and returns true, otherwise returns false",
  ...
  SECTION("Returns true and updates the head node with the supplied data.") {
    LinkedList<int, int> list;
...
TEST_CASE("Updates the last element and returns true, otherwise returns false",
  ...
  SECTION("Returns true and updates the tail node with the supplied data.") {
    LinkedList<int, int> list;
...
TEST_CASE("Returns the amount of times the data occurs within the list",
          "[Count]") {
  ...
  SECTION(
      "Returns the number of times the specifies data appears in the list.") {
    LinkedList<int, int> list;
...
TEST_CASE("Operator[] Returns the node at the specifed index", "[operator[]]") {
  ...
  SECTION("Returns the node at the specified index.") {
    ...
    REQUIRE(list[0]->data == 2);
    REQUIRE(list[1]->data == 3);
    REQUIRE(list[2]->data == 5);
  }
}
...
TEST_CASE("Returns true if the lists have exactly the same data & length.",
          "[Operator==]") {
  ...
  SECTION(
      "Returns false if the sizes of the list are the same but the data is "
      "different.") {
    LinkedList<int, int> list;
    list.PushBack(1);
    list.PushBack(2);
  ...
  SECTION(
      "Returns true if the sizes of the list are the same and the data is the "
      "same.") {
    LinkedList<int, int> list;
    list.PushBack(1);
    list.PushBack(2);
...
TEST_CASE("Returns true if the lists are different.", "[Operator!=]") {
  ...
  SECTION(
      "Returns true if the sizes of the list are the same but the data is "
      "different.") {
    LinkedList<int, int> list;
    list.PushBack(1);
    list.PushBack(2);
  ...
  SECTION(
      "Returns false if the sizes of the list are the same and the data is the "
      "same.") {
    LinkedList<int, int> list;
    list.PushBack(1);
    list.PushBack(2);
...
TEST_CASE(
    ...
    "node gets set to the default value of the data type.",
    "[operator++]") {
  LinkedList<int, int> list;
...
TEST_CASE(
    ...
    "provided. The added nodes get set to the default value of the data type.",
    "[operator+=]") {
  LinkedList<int, int> list;
...
TEST_CASE(
  ...
  list.InsertManyAtEnd({1, 2, 2, 4});

  LinkedList<int, int> otherList;
  otherList.InsertManyAtEnd({1, 2, 2, 3, 4, 5, 65, 6});

  bool isLessThan = list < otherList;

  REQUIRE(isLessThan == true);

  list.InsertManyAtEnd({1, 2, 2, 3, 4, 5, 6, 7, 8});
...
TEST_CASE(
  ...
  LinkedList<int, int> otherList;
  otherList.InsertManyAtEnd({1, 2, 2});
...
TEST_CASE(
  ...
  SECTION(
      ...
      "destroyed.") {
    LinkedList<int, int> list;
    list.InsertManyAtEnd({1, 2, 3, 4, 5});
    REQUIRE(list.Size() == 5);
...
TEST_CASE("Swaps two linked lists.", "[Swap]") {
  ...
  SECTION(
    ...
    LinkedList<int, int> otherList;
    otherList.PushFront(5);
    otherList.PushFront(3);
    otherList.PushFront(2);
    ...
    REQUIRE(otherList.At(0)->data == 2);
    REQUIRE(otherList.At(1)->data == 3);
    REQUIRE(otherList.At(2)->data == 5);
    ...
    REQUIRE(otherList.At(0)->data == 2);
    REQUIRE(otherList.At(1)->data == 8);
    REQUIRE(otherList.At(2)->data == 2);
    REQUIRE(otherList.At(3)->data == 4);
    REQUIRE(otherList.At(4)->data == 5);
  }
  ...
  SECTION(
    ...
    otherList.PushFront(3);
    otherList.PushFront(2);
    otherList.PushFront(8);
    otherList.PushFront(2);

    REQUIRE(list.At(0)->data == 2);
    REQUIRE(list.At(1)->data == 4);
    REQUIRE(list.At(2)->data == 5);

    REQUIRE(otherList.At(0)->data == 2);
    REQUIRE(otherList.At(1)->data == 8);
    REQUIRE(otherList.At(2)->data == 2);
    REQUIRE(otherList.At(3)->data == 3);
    REQUIRE(otherList.At(4)->data == 5);
